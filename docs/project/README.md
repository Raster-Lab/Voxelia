# Voxelia governing documents

The corrective-release governing baseline comprises:

1. `Voxelia_Project_Foundation_v0.1.1.md`
2. `Voxelia_Master_Technical_Architecture_v0.1.1.md`
3. `Voxelia_Requirements_Baseline_v0.1.1.md`
4. `Voxelia_Validation_and_Benchmark_Strategy_v0.1.1.md`
5. `Voxelia_Repository_and_Package_Scaffold_Specification_v0.1.1.md`
