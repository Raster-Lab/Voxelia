...
REQUIRED = [
    ...
    "Benchmarks/Package.swift", "Tools/Package.swift", "Tools/Schemas/VoxeliaSBOM.schema.json", "Tools/Scripts/assert-apple-platform.sh", "Tools/Scripts/build-docc.sh", "Tools/Scripts/check_docc_archives.py", "Tools/Scripts/check_manifest_paths.py", "Tools/Scripts/check_release_integrity.py", "Tools/Scripts/generate-sbom.sh", "Tools/Scripts/generate_sbom.py", "Tools/Scripts/generate_requirement_index.py", "Tools/Scripts/test-repository-scripts.sh", "docs/project", "docs/architecture/decisions/ADR-0001-apple-ecosystem-only.md", ".github/workflows",
]
